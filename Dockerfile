# Dockerfile.rocm (Final v8 - Integrated Best Practices)
...
# Set ROCm environment variables (Corrected typo)
...
RUN mkdir -p /root/.local/share/tts /workspace/outputs # Keep model cache path, outputs relative to WORKDIR
